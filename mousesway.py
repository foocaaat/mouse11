...
while True:
    ...
    if key == 1: 
        ...
        if (VY + VX != 0 ):
#       	    mouse.move(VX,VY)
            os.system("swaymsg -s /run/user/1000/sway-ipc.1000.46120.sock seat - cursor move\ {}\ {} &".format(VX, VY))
        ...
        if keyboard.is_pressed('space') == True and l2 == 0:
            os.system("swaymsg -s /run/user/1000/sway-ipc.1000.46120.sock seat - cursor press BTN_LEFT &".format(VX, VY))
            l2=1
        if keyboard.is_pressed('space') == False and l2 == 1:
            os.system("swaymsg -s /run/user/1000/sway-ipc.1000.46120.sock seat - cursor release BTN_LEFT &".format(VX, VY)) 
            l2=0
